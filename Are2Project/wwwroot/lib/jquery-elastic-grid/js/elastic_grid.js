...
$(function () {
    ...
    $.fn.elastic_grid = function (config) {
        ...
        var container = $(this);
        // number of questions
        var numOfItems = config.items ? config.items.length : 0;
        if (numOfItems == 0) {
            return false;
        }
        ...
        ***************************************************************************/
        ...
        Preview.prototype = {
                ...
                if (typeof config.items[current] === "undefined") {
                    ...
                    if (glarge.length == gthumbs.length && glarge.length > 0) {
                        ...
                        for (i = 0; i < gthumbs.length; i++) {
                            ...
                            ObjImg.attr('alt', imgTitle);
                            ObjImg.attr('title', imgTitle);
                            ObjA.append(ObjImg);
                            Objli.append(ObjA);
                            ObjUl.append(Objli);
                        }
            ...
            calcHeight: function () {
                ...
                var heightPreview = 400; //winsize.height - this.$item.data('height') - marginExpanded,
                itemHeight = 400; //winsize.height;
